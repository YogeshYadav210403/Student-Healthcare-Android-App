...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edPassword = findViewById(R.id.editTextRegAppContactNumber);
                ...
                if (username.length()==0 || email.length()==0 || password.length()==0 || confirm.length()==0){
                    ...
                    if (password.compareTo(confirm)==0){
                        if (isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(),"Password must contain at least 8 character having letter, digit and special symbol",Toast.LENGTH_LONG).show();
                        }
                    }else {
